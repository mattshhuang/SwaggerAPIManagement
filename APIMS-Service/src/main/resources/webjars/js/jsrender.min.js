...
;!function(e, t) {
    ...
    "object" == typeof exports ? module.exports = n ? e(t, n) : function(n) {
        ...
        function r(e, t) {
            return ne(t) && (t = n(e ? e._d ? e: n(a, e) : a, t), t._d = 1),
                t
        }
        function i(e, t) {
        ...
        function s(e) {
            try {
                throw console.log("JsRender dbg breakpoint: " + e),
                    "dbg breakpoint"
            } catch(t) {}
        ...
        function c(e, t) {
            ...
            else for (; a && !o;) o = a.type === t ? a: void 0,
                    a = a.parent;
            return o
        }
        function p() {
        ...
        function g(t, n, r) {
            var i, o, a, s, d = this,
                ...
                c = d.ctx;
            if (t in c || t in (c = ae)) {
                if (a = c && c[t], "tag" === t || "root" === t || "parentTags" === t || d._.it === t) return a
            } else c = void 0;
            if ((!a || !ne(a) && d.linked || d.tagCtx) && (a && a._cxp || (c !== ae && (d = d.ctx && d.ctx.tag || d.root, c = d._ocps, a = c && c[t] || a), a && a._cxp || !r && !u || (a = de._crcp(t, a, d, c))), s = a && a._cxp)) {
                if (u) return de._ucp(t, n, d, s);
                if (r) return o = a[1] ? de._ceo(a[1].deps) : [_e],
                    o.unshift(a[0]),
                    o._cxp = s,
                    o;
        ...
        function h(e, t, n, r) {
            ...
            return void 0 === r && s && s._lr && (r = ""),
                ...
                s = s._bd && s,
                a = n.args[0],
            (e || s) && (o = d && d.tag, n.view = t, o || (o = l(new de._tg, {
                _: {
                    inline: !d,
                    bnd: s,
                    unlinked: !0
                ...
                flow: !0,
                tagCtx: n
            }), d && (d.tag = o, o.linkCtx = d), n.ctx = Q(n.ctx, (d ? d.view: t).ctx), i(o, n)), o._er = r && a, o.ctx = n.ctx || o.ctx || {},
                n.ctx = void 0, a = o.cvtArgs("true" !== e && e)[0]),
        ...
        function m(e, t, n) {
            ...
            if (l.tagName ? (d = l, l = d.tagCtxs ? d.tagCtxs[n || 0] : d.tagCtx) : (d = l.tag, n = l.index), s = d.bindTo, a = l.args, e = e || d.convert, "" + e === e && (e = l.view.getRsc("converters", e) || I("Unknown converter: '" + e + "'")), a.length || d.argDefault === !1 || l.index ? e && !t && (a = a.slice()) : a = [l.view.data], s) {
                for (o = [], r = s.length; r--;) i = s[r],
                    o.unshift(w(l, i));
                t && (a = o)
            }
            if (e) if (s = s || [0], e = e.apply(d, o || a), r = s.length, e = r < 2 ? [e] : e || [], t) a = e;
            else for (; r--;) i = s[r],
                +i === i && (a[i] = e ? e[r] : void 0);
            return a
        }
        function w(e, t) {
            return e = e[ + t === t ? "args": "props"],
            e && e[t]
        }
        function x(e) {
        ...
        function _(e, t) {
            for (var n, r, i = this; void 0 === n && i;) r = i.tmpl && i.tmpl[e],
                n = r && r[t],
                i = i.parent;
            return n || ee[e][t]
        }
        function b(e, t, n, r, o, a) {
            t = t || Y;
            var s, d, l, u, c, p, f, g, v, h, m, x, _, b, y, k, C, j, T, A, V, R, $ = 0,
                E = "",
                M = t.linkCtx || 0,
                N = t.ctx,
                P = n || t.tmpl,
                O = "number" == typeof r && t.tmpl.bnds[r - 1];
            for ("tag" === e._is ? (s = e, e = s.tagName, r = s.tagCtxs, l = s.template) : (d = t.getRsc("tags", e) || I("Unknown tag: {{" + e + "}} "), l = d.template), void 0 === a && O && O._lr && (a = ""), void 0 !== a ? (E += a, r = a = [{
                props: {},
                args: []
            }]) : O && (r = O(t.data, t, de)), f = r.length; $ < f; $++) h = r[$],
            (!M || !M.tag || $ && !M.tag._.inline || s._er) && ((b = P.tmpls && h.tmpl) && (b = h.content = P.tmpls[b - 1]), h.index = $, h.tmpl = b, h.render = S, h.view = t, h.ctx = Q(h.ctx, N)),
            (n = h.props.tmpl) && (h.tmpl = t.getTmpl(n)),
            s || (s = new d._ctr, y = !!s.init, s.parent = p = N && N.tag, s.tagCtxs = r, A = s.dataMap, M && (s._.inline = !1, M.tag = s, s.linkCtx = M), (s._.bnd = O || M.fn) ? s._.arrVws = {}: s.dataBoundOnly && I(e + " must be data-bound:\n{^{" + e + "}}")),
                _ = s.bindTo || [0],
                r = s.tagCtxs,
                A = s.dataMap,
                h.tag = s,
            A && r && (h.map = r[$].map),
            s.flow || (m = h.ctx = h.ctx || {},
                u = s.parents = m.parentTags = N && Q(m.parentTags, N.parentTags) || {},
            p && (u[p.tagName] = p), u[s.tagName] = m.tag = s);
            if (! (s._er = a)) {
                for (i(s, r[0]), s.rendering = {},
                         $ = 0; $ < f; $++) {
                    if (h = s.tagCtx = r[$], T = h.props, s.ctx = h.ctx, $ || (y && (s.init(h, M, s.ctx), y = void 0), M && (M.attr = s.attr = M.attr || s.attr), c = s.attr, s._.noVws = c && c !== Pe), j = s.cvtArgs(void 0, void 0, $), s.linkedCtxParam) for (g = _.length; g--;)(x = s.linkedCtxParam[g]) && (R = _[g], h.ctx[x] = de._cp(w(h, R), w(h.params, R), h.view, s._.bnd && {
                        tag: s,
                        ind: g,
                        tagElse: $
                    })); (k = T.dataMap || A) && (j.length || T.dataMap) && (C = h.map, C && C.src === j[0] && !o || (C && C.src && C.unmap(), C = h.map = k.map(j[0], T, void 0, !s._.bnd)), j = [C.tgt]),
                        v = void 0,
                    s.render && (v = s.render.apply(s, j), t.linked && v && !Me.test(v) && (n = {
                        links: []
                    },
                        n.render = n.fn = function() {
                            return v
                        },
                        v = F(n, t.data, void 0, !0, t, void 0, void 0, s))),
                    j.length || (j = [t]),
                    void 0 === v && (V = j[0], s.contentCtx && (V = s.contentCtx === !0 ? t: s.contentCtx(V)), v = h.render(V, !0) || (o ? void 0 : "")),
                        E = E ? E + (v || "") : v
                }
                s.rendering = void 0
            }
            return s.tagCtx = r[0],
                s.ctx = s.tagCtx.ctx,
            s._.noVws && s._.inline && (E = "text" === c ? oe.html(E) : ""),
                O && t._.onRender ? t._.onRender(E, t, s) : E
        }
        function y(e, t, n, r, i, o, a, s) {
            ...
            c.content = s,
                ...
                c.linked = !!a,
                n ? (d = n.views, l = n._, l.useKey ? (d[u.key = "_" + l.useKey++] = c, c.index = qe, c.getIndex = p) : d.length === (u.key = c.index = o) ? d.push(c) : d.splice(o, 0, c), c.ctx = e || n.ctx) : c.ctx = e || {}
        }
        function k(e) {
            var t, n, r;
            for (t in Le) n = t + "s",
        ...
        function C(e, t, n) {
            ...
            function o(e) {
                var n; (n = t[e]) && (t[e] = n = re(n) ? n: [n], (p || 1) !== n.length && I(e + " length not same as bindTo "))
            }
            ...
            if (ne(t) ? t = {
                ...
                template: t
            }), void 0 !== f) for (f = t.bindTo = re(f) ? f: [f], u = p = f.length; u--;) c = f[u],
            isNaN(parseInt(c)) || (c = parseInt(c)),
                f[u] = c;
            if (o("linkedElement"), o("linkedCtxParam"), s = t.baseTag) {
                t.flow = !!t.flow,
                    t.baseTag = s = "" + s === s ? n && n.tags[s] || se[s] : s,
                    g = l(g, s);
                for (d in t) g[d] = r(s[d], t[d])
            } else g = l(g, t);
            return void 0 !== (a = g.template) && (g.template = "" + a === a ? ie[a] || ie(a) : a),
                (i.prototype = g).constructor = g._ctr = i,
            n && (g._parentTmpl = n),
                g
        }
        function j(e) {
        ...
        function T(e, n, r, i) {
            function o(n) {
                ...
                if ("" + n === n || n.nodeType > 0 && (a = n)) {
                    if (!a) if (/^\.\/[^\\:*?"<>]*$/.test(n))(s = ie[e = e || n]) ? n = s: a = document.getElementById(n);
                    else if (t.fn && !de.rTmpl.test(n)) try {
                        a = t(n, document)[0]
                    } catch(d) {}
                    a && (i ? n = a.innerHTML: (o = a.getAttribute(Oe), o && (o !== Ue ? (n = ie[o], delete ie[o]) : t.fn && (n = t.data(a)[Ue])), o && n || (e = e || (t.fn ? Ue: n), n = T(e, a.innerHTML, r, i)), n.tmplName = e = e || o, e !== Ue && (ie[e] = n), a.setAttribute(Oe, e), t.fn && t.data(a, Ue, n))),
                        a = void 0
                } else n.fn || (n = void 0);
                return n
            }
            var a, s, d = n = n || "";
            if (0 === i && (i = void 0, d = o(d)), i = i || (n.markup ? n: {}), i.tmplName = e, r && (i._parentTmpl = r), !d && n.markup && (d = o(n.markup)) && d.fn && (d = d.markup), void 0 !== d) return d.fn || n.fn ? d.fn && (s = d) : (n = $(d, i), U(d.replace(je, "\\$&"), n)),
            s || (s = l(function() {
        ...
        function R(e, n) {
            ...
            function o(e, t) {
                for (var n, r, i, o, a = 0; a < w; a++) i = p[a],
                    n = void 0,
                i + "" !== i && (n = i, i = n.getter),
                void 0 === (o = e[i]) && n && void 0 !== (r = n.defaultVal) && (o = A(r, e)),
                    t(o, n && c[n.type], i)
            }
            function a(t) {
            ...
            function d() {
                ...
                t + "" !== t && (n = t, t = n.getter),
                    r = o[t](),
                    e[t] = n && r && c[n.type] ? re(r) ? V(r) : r.unmap() : r;
            ...
            return u = new Function(h, m.slice(0, -1)),
                u.prototype = v,
                v.constructor = u,
                i.map = a,
                i.getters = p,
        ...
        function $(e, n) {
            var r, i = ue._wm || {},
                o = l({
                    ...
                    n);
            return o.markup = e,
            n.htmlTag || (r = Ve.exec(e), o.htmlTag = r ? r[1].toLowerCase() : ""),
                r = i[o.htmlTag],
        ...
        function E(e, t) {
            function n(i, o, a) {
                ...
                return void 0 === o && (o = i, i = void 0),
                i && "" + i !== i && (a = o, o = i, i = void 0),
                    l = a ? "viewModel" === e ? a: a[r] = a[r] || {}: n,
                    s = t.compile,
                    null === o ? i && delete l[i] : (s && (o = s.call(l, i, o, a, 0), o._is = e), i && (l[i] = o)),
                u && u(i, o, a, s),
                    o
            }
            var r = e + "s";
        ...
        function S(e, t, n, r, i, o) {
            ...
            if (t === !0 ? (n = t, t = void 0) : typeof t !== Ie && (t = void 0), (d = this.tag) ? (u = this, g = g || u.view, l = g.getTmpl(d.template || u.tmpl), arguments.length || (e = g)) : l = this, l) {
                if (!r && e && "view" === e._is && (g = e), g && e === g && (e = g.data), c = !g, we = we || c, g || ((t = t || {}).root = e), !we || ue.useViews || l.useViews || g && g !== Y) v = F(l, e, t, n, g, i, o, d);
                    ...
                    if (g ? (p = g.data, f = g.index, g.index = qe) : (g = Y, g.data = e, g.ctx = t), re(e) && !n) for (a = 0, s = e.length; a < s; a++) g.index = a,
                        g.data = e[a],
                        v += l.fn(e[a], g, de);
                    else g.data = e,
                        v += l.fn(e, g, de);
        ...
        function F(e, t, n, r, i, o, a, s) {
            ...
            if (s && (w = s.tagName, b = s.tagCtx, n = n ? Q(n, s.ctx) : s.ctx, e === i.content ? h = e !== i.ctx._wrp ? i.ctx._wrp: void 0 : e !== b.content ? e === s.template ? (h = b.tmpl, n._wrp = b.content) : h = b.content || i.content: h = i.content, b.props.link === !1 && (n = n || {},
                n.link = !1), (x = b.props.itemVar) && ("~" !== x.charAt(0) && O("Use itemVar='~myItem'"), x = x.slice(1))), i && (a = a || i._.onRender, n = Q(n, i.ctx)), o === !0 && (v = !0, o = 0), a && (n && n.link === !1 || s && s._.noVws) && (a = void 0), m = a, a === !0 && (m = void 0, a = i._.onRender), n = e.helpers ? Q(e.helpers, n) : n, _ = n, re(t) && !r) for (p = v ? i: void 0 !== o && i || new y(n, "array", i, t, e, o, a, h), i && i._.useKey && (p._.bnd = !s || s._.bnd && s), u = 0, c = t.length; u < c; u++) x && d(t[u]),
                f = new y(_, "item", p, t[u], e, (o || 0) + u, a, p.content),
                f._.it = x,
                g = e.fn(t[u], f, de),
                k += p._.onRender ? p._.onRender(g, f) : g;
            else x && d(t),
                p = v ? i: new y(_, w || "data", i, t, e, o, a, h),
                p._.it = x,
                k += e.fn(t, p, de);
            return s && (p.tag = s, p.tagElse = b.index, b.contentView = p),
                m ? m(k, p) : k
        }
        function P(e, t, n) {
            var r = void 0 !== n ? ne(n) ? n.call(t.data, e, t) : n || "": "{Error: " + (e.message || e) + "}";
            return le.onError && void 0 !== (n = le.onError.call(t.data, e, n && r, t)) && (r = n),
                t && !t.linkCtx ? oe.html(r) : r
        }
        function I(e) {
            throw new de.Err(e)
        }
        ...
        function U(e, t, n, r, i) {
            function o(t) {
                t -= v,
                t && m.push(e.substr(v, t).replace(ke, "\\n"))
            }
            function a(t, n) {
                t && (t += "}}", O((n ? "{{" + n + "}} block has {{/" + t + " without {{" + t: "Unmatched or missing {{/" + t) + ", in template:\n" + e))
            }
            function s(s, d, l, p, g, x, _, b, y, k, C, j) { (_ && d || y && !l || b && ":" === b.slice( - 1) || k) && O(s),
            x && (g = ":", p = Pe),
                y = y || n && !i;
                var T, A = (d || n) && [[]],
                    V = "",
                ...
                l = l || (b = b || "#data", g),
                    o(j),
                    v = j + s.length,
                    _ ? f && m.push(["*", "\n" + b.replace(/^:/, "ret+= ").replace(Ce, "$1") + ";\n"]) : l ? ("else" === l && (Ae.test(b) && O('for "{{else if expr}}" use "{{else expr}}"'), A = w[8] && [[]], w[9] = e.substring(w[9], j), w = h.pop(), m = w[2], P = !0), b && B(b.replace(ke, " "), A, t).replace(Te,
                        function(e, t, n, r, i, o, a, s) {
                            return r = "'" + i + "':",
                                a ? (R += o + ",", E += "'" + s + "',") : n ? ($ += r + "j._cp(" + o + ',"' + s + '",view),', N += r + "'" + s + "',") : t ? S += o: ("trigger" === i && (F += o), "lateRender" === i && (T = 1), V += r + o + ",", M += r + "'" + s + "',", c = c || Ee.test(i)),
                                ""
                        }).slice(0, -1), A && A[0] && A.pop(), u = [l, p || !!r || c || "", P && [], J(E || (":" === l ? "'#data',": ""), M, N), J(R || (":" === l ? "data,": ""), V, $), S, F, T, A || 0], m.push(u), P && (h.push(w), w = u, w[9] = v)) : C && (a(C !== w[0] && "else" !== w[0] && C, w[0]), w[9] = e.substring(w[9], j), w = h.pop()),
                    a(!w && C),
                    m = w[2]
            }
            ...
            function r(r, m, w, x, _, b, y, k, C, j, T, A, V, R, $, E, M, N, S, F) {
                ...
                if ("[" === j && (j = "[j._sq(", L = ")]"), !y || d || s) {
                    if (l && E && !d && !s && (!i || a || o) && (I = h[g - 1], F.length - 1 > S - (I || 0))) {
                        if (I = F.slice(I, S + r.length), q !== !0) if (J = o || c[g - 1].bd, K = J[J.length - 1], K && K.prm) {
                        ...
                        E = fe + ":" + I + " onerror=''" + ge,
                            q = f[E],
                        q || (f[E] = !0, f[E] = q = U(E, n, !0)),
                        q !== !0 && B && (B._cpfn = q, B.prm = u.bd, B.bnd = B.bnd || B.path && B.path.indexOf("^") >= 0)
                    }
        ...
        function D(e) {
            var t, n, r = [];
            if (typeof e === Ie) for (t in e) n = e[t],
            t !== te && e.hasOwnProperty(t) && !ne(n) && r.push({
                key: t,
                prop: n
            });
            return r
        ...
        var G = t === !1;
        t = t && t.fn ? t: e.jQuery;
        var W, X, Y, ee, te, ne, re, ie, oe, ae, se, de, le, ue, ce, pe, fe, ge, ve, he, me, we, xe = "v0.9.87",
            _e = "_ocp",
        ...
        if (ee = {
            ...
            oe = ee.converters,
                ...
                Y = de.topView = new y,
                t ? (t.fn.render = Z, te = t.expando, t.observable && (l(de, t.views.sub), ee.map = t.views.map)) : (t = {},
                G && (e.jsrender = t), t.renderFile = t.__express = t.compile = function() {
                ...
                t.render = Je,
                t.views = ee,
                t.templates = ie = ee.templates;
            for (me in le) M(me); (ce.debugMode = function(e) {
                    ...
                    "for": {
                        render: function(e) {
                            var t, n = !arguments.length,
                                ...
                                o = "",
                                a = 0;
                            return r.rendering.done || (t = n ? i.view.data: e, void 0 !== t && (o += i.render(t, n), a += re(t) ? t.length: 1), (r.rendering.done = a) && (r.selected = i.index)),
                                o
                        },
                        flow: !0
                    },
        ...
        return le = de.settings,
            re = (t || Ke).isArray,
            ce.delimiters("{{", "}}", "^"),
        Be && Ke.views.sub._jq(t),
        t || Ke
    },
    window);
